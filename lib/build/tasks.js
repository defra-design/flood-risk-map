...
const appImagesPath = path.join(paths.assets, 'images')
...
function generateAssets () {
  ...
  buildJavascript(paths.assets, paths.public)
...
function copyAssets (sourcePath, targetPath) {
  ...
  const filterFunc = (src) => !src.startsWith(path.join(sourcePath, 'sass')) && !src.startsWith(path.join(sourcePath, 'javascripts'))
